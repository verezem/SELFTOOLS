...
for sec in AR7W 60N A24N ovide ; do
ncrcat -O ${CONFCASE}_y????_${sec}.nc $DIAGDIR/2002-2015/${CONFCASE}_y1992-2015_${sec}.nc
done
ncrcat -O ${CONFCASE}_y????_eke.nc $DIAGDIR/1993-2015/${CONFCASE}_y1992-2015_eke.nc
