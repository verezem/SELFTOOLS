...
cdfmoy_weighted -l $DIAGDIR/${year}/${CONFCASE}_y${year}.${freq2}_sshmean.nc -o ${CONFCASE}_y${year}_sshmean.nc
done
for year in {1993..2015} ; do
...
# Concatenate curl files
for year in {1993..2015} ; do
ln -sf $DIAGDIR/${year}/${CONFCASE}_y${year}.${freq2}_curl.nc .
done
ncrcat ${CONFCASE}_y????.${freq2}_curl.nc ${CONFCASE}_y1993-2015.${freq2}_curl.nc
...
for sec in AR7W 60N ovide ; do
ncrcat ${CONFCASE}_y????_${sec}.nc $DIAGDIR/1993-2015/${CONFCASE}_y1993-2015_${sec}.nc
done

# OHC
for dep in 200 700 1500 3000 ; do
for year in {1993..2015} ; do
ln -sf $DIAGDIR/${year}/${CONFCASE}_y${year}_ohc${dep}.nc $WORKDIR/TMP$$
done
ncrcat -O ${CONFCASE}_y????_ohc${dep}.nc ${CONFCASE}_y1993-2015_ohc${dep}.nc
done
...
for lev in 1 47 ; do
for var in  m${GRID1}_minmax m${GRID1} m${GRIDU} m${GRIDV} s${GRID1} current ; do
ncrcat -O ${CONFCASE}_y????.l${lev}_${var}.nc $DIAGDIR/1993-2015/${CONFCASE}_y1993-2015_${var}.l${lev}.nc
done
done
ncrcat -O ${CONFCASE}_y????_eke.nc $DIAGDIR/1993-2015/${CONFCASE}_y1993-2015_eke.nc
