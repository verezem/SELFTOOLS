...
# Concatenate them betwenn each other for the whole period of run
#for typ in sshmean sssmean sstmean Ntsdiag Itsdiag Ltsdiag Atsdiag mbotT ; do
...
#done
for sec in AR7W 60N A24N ovide ; do
ncrcat -O ${CONFCASE}_y????_${sec}.nc $DIAGDIR/2002-2015/${CONFCASE}_y2002-2015_${sec}.nc
done
